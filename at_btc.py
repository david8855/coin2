        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10): 
           ...
           if target_price < current_price and current_price < predicted_close_price and ma5 < current_price and ma10 < current_price: 
              ...
              if krw > 5000: 
                  ...
                  post_message(myToken,"#myinvest", "BTC buy : " +str(buy_result)) 
        else: 
           btc = get_balance("BTC") 
           if btc !=0: 
               upbit.sell_market_order("KRW-BTC", btc*1) 
               sell_result=upbit.sell_market_order("KRW-BTC", btc*1) 
               post_message(myToken,"#myinvest", "BTC buy : " +str(sell_result))
        time.sleep(1) 
