        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10): 
           ...
           if target_price < current_price and current_price < predicted_close_price and ma5 < current_price and ma10 < current_price: 
              ...
              if krw > 5000: 
                  ...
                  post_message(myToken,"#myinvest", "XRP buy : " +str(buy_result)) 
        else: 
           XRP = get_balance("XRP") 
           if XRP !=0: 
               upbit.sell_market_order("KRW-XRP", XRP*1) 
               sell_result=upbit.sell_market_order("KRW-XRP", XRP*1) 
               post_message(myToken,"#myinvest", "XRP buy : " +str(sell_result))
        time.sleep(1) 
