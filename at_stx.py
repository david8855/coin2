...
while True: 
    try: 
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10): 
           target_price = get_target_price("KRW-STX", 0.4) 
           ma10 = get_ma10("KRW-STX")
           ma5 = get_ma5("KRW-STX")
           ...
           if target_price < current_price and current_price < predicted_close_price and ma5 < current_price and ma10 < current_price: 
              ...
              if krw > 5000: 
                  ...
                  buy_result=upbit.buy_market_order("KRW-STX", krw*0.9995)
                  post_message(myToken,"#myinvest", "STX buy : " +str(buy_result)) 
        else: 
           STX = get_balance("STX") 
           if STX !=0: 
               upbit.sell_market_order("KRW-STX", STX*1) 
               sell_result=upbit.sell_market_order("KRW-STX", STX*1) 
               post_message(myToken,"#myinvest", "STX buy : " +str(sell_result))
        time.sleep(1) 
