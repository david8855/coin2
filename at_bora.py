...
while True: 
    try: 
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10): 
           target_price = get_target_price("KRW-BORA", 0.4) 
           ma10 = get_ma10("KRW-BORA")
           ...
           if target_price < current_price and current_price < predicted_close_price and ma5 < current_price and ma10 < current_price: 
              ...
              if krw > 5000: 
                  ...
                  post_message(myToken,"#myinvest", "BORA buy : " +str(buy_result)) 
        else: 
           BORA = get_balance("BORA") 
           if BORA !=0: 
               upbit.sell_market_order("KRW-BORA", BORA*1) 
               sell_result=upbit.sell_market_order("KRW-BORA", BORA*1) 
               post_message(myToken,"#myinvest", "BORA buy : " +str(sell_result))
        time.sleep(1) 
